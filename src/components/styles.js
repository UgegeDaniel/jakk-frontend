...
//STYLES HOOK (ARRANGED BY THE APP COMPONENT'S SUB-COMPONENTS)
export const useStyles = makeStyles((theme) => ({
    ...
    googleBtn: { borderRadius: constants.borderRadius },
    //      >>>>        DASHBOARD
    ...
    notification: { position: "fixed", left: '20vw', marginTop: '20px', top: '10vh', zImdex: 3 },
    avatar1: { margin: theme.spacing(1), backgroundColor: theme.palette.secondary.main, },
    inputExample: { fontSize: "12px", marginTop: -10, marginBottom: 20, marginRight: 20 },
